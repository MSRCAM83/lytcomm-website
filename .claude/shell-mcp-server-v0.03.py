...
# TransportSecuritySettings removed — handled via env var for mcp 1.26.0+
...
mcp = FastMCP(
    ...
    host="0.0.0.0",
    port=9001,
    stateless_http=True,  # CRITICAL: Claude.ai doesn't propagate mcp-session-id headers
)
...
if __name__ == "__main__":
    ...
    # DNS rebinding protection disabled via MCP_TRANSPORT_SECURITY__ENABLE_DNS_REBINDING_PROTECTION env var
