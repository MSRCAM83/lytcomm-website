...
Then fetch COMFYUI-MCP-BRAIN.md:
curl -sL https://api.github.com/repos/MSRCAM83/lytcomm-website/contents/.claude/COMFYUI-MCP-BRAIN.md
Decode base64 content and load into context.
```
...
## UPDATING THE BRAIN
At the end of sessions where meaningful changes occurred (new nodes installed, new models downloaded, new workflows created, bugs fixed, preferences changed), UPDATE the relevant project brain (e.g. COMFYUI-MCP-BRAIN.md) in GitHub:
...
## BRAIN ARCHITECTURE
- **MASTER-BRAIN.md** = God Brain. WHO Matt is. Tokens, rules, identity. Loaded EVERY conversation.
- **{PROJECT}-BRAIN.md** = Project Brain. WHAT we're building. Has [CURRENT STATE] at the top for volatile short-term data. Loaded when working on that project.
- **Memory Edits** = Fastest access. 30 slots. Active instance, current task, token refs.
- **Conversation Search** = Automatic short-term recall.

Current project brains:
- `COMFYUI-MCP-BRAIN.md` — ComfyUI, Vast.ai, MCP servers, image/video generation
