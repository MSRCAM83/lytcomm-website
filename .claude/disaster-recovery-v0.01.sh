...
#   5. Runs image generation test
#
# WHAT YOU DO AFTER (manual):
#   6. Add MCP connectors in Claude.ai
#   7. Re-add memory edits
#   8. Set up Claude Project with instructions
#
# RUN FROM: Any machine with bash + curl + python3
#
# BEFORE RUNNING — set your tokens as env vars:
#   export VAST_API_KEY="your-vast-api-key"
#   export GITHUB_PAT="your-github-pat"
#   export HF_TOKEN="your-hf-token"
#   export CIVITAI_TOKEN="your-civitai-token"
#
# Then:
#   bash disaster-recovery-v0.01.sh
#
# ALSO AVAILABLE AT:
#   curl -sL https://raw.githubusercontent.com/MSRCAM83/lytcomm-website/main/.claude/disaster-recovery-v0.01.sh | bash
#
# Token values are in your MASTER-BRAIN.md on GitHub (private repo).
###############################################################################
...
# === TOKENS (hardcoded per Matt's rules) ===
VAST_TOKEN="${VAST_API_KEY:?Set VAST_API_KEY env var or edit this line}"
GH_PAT="${GITHUB_PAT:?Set GITHUB_PAT env var or edit this line}"
HF_TOKEN="${HF_TOKEN:?Set HF_TOKEN env var or edit this line}"
CIVITAI_TOKEN="${CIVITAI_TOKEN:?Set CIVITAI_TOKEN env var or edit this line}"
...
echo ""
echo "In a new conversation, tell Claude to add these memory edits:"
echo ""
cat << 'MEMORY'
1. EVERY convo start: Do 8+ conversation_search calls from multiple angles + recent_chats. Never skim.
2. Vast.ai API key: <your-vast-api-key>
3. HF token: <your-hf-token> | CivitAI token: <your-civitai-token>
4. GitHub PAT: <your-github-pat>
5. Always use single GPU instances for troubleshooting. Multi-GPU only when Claude operates autonomously.
6. When Matt says "start the mcp" → use Shell MCP to run: supervisorctl restart comfyui-mcp shell-mcp.
7. Provisioning: v0.07. Shell MCP: v0.03 (stateless_http=True). 34 tools total operational.
8. 🔒 LOCKED COMPONENTS — DO NOT MODIFY without Matt's explicit approval.
9. CRITICAL LAUNCH FIX: template_id 336394 overrides PROVISIONING_SCRIPT env. Use onstart export trick.
10. Vast search API: ALL values need operator syntax {"eq":true} not true.
MEMORY
echo ""
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo " Script saved to GitHub at:"
echo " .claude/disaster-recovery-v0.01.sh"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
